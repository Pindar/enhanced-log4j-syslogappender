...
/**
 * SyslogWriter that allows to send packets that are grater then 1024 bytes
 *
...
public class SyslogWriter extends Writer {
    ...
    public
    SyslogWriter(final String syslogHost, final String maxPackageSize) {
        this(syslogHost);
        this.maxPackageSize = Integer.valueOf(maxPackageSize);
    }
